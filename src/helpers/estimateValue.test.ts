...
describe('estimateValue', () => {
    const currencies = [{id: 'eth', precision: 5}, {id: 'usd', precision: 4}, {id: 'btc', precision: 3}, {id: 'rht', precision: 8}] as Currency[];
    ...
    it('should convert using secondary market #1', () => {
        ...
        const markets = [
            {id: 'btcrht', name: 'BTC/RHT', base_unit: 'btc', quote_unit: 'rht'},
            {id: 'bchrht', name: 'BCH/RHT', base_unit: 'bch', quote_unit: 'rht'},
        ] as Market[];
        const marketTickers = {btcrht: {last: '0.1'}, bchrht: {last: '10'}} as unknown as MarketTicker;
    ...
    it('should convert using secondary market #2', () => {
        ...
        const marketTickers = {btcrht: {last: '10'}, bchrht: {last: '10'}} as unknown as MarketTicker;
    ...
    it('should convert using secondary market #3', () => {
        ...
        const marketTickers = {btcrht: {last: '9.995'}, bchrht: {last: '5.005'}} as unknown as MarketTicker;
    ...
    it('should NOT convert using tertiary market', () => {
        ...
        const markets = [
            {id: 'btcrht', name: 'BTC/RHT', base_unit: 'btc', quote_unit: 'rht'},
            {id: 'ltcrht', name: 'LTC/RHT', base_unit: 'ltc', quote_unit: 'rht'},
    ...
    it('should convert with small ticker value', () => {
        ...
        const marketTickers = {
            btcrht: {last: '0.00000001'},
            bchrht: {last: '0.00000002'},
        } as unknown as MarketTicker;
    ...
    it('should find precision using market ask unit', () => {
        const unit = 'btc';
        const markets = [
            {id: 'btcrht', name: 'BTC/RHT', base_unit: 'btc', quote_unit: 'rht', amount_precision: 3},
        ] as Market[];
    ...
    it('should find precision using market bid unit', () => {
        const unit = 'btc';
        const markets = [
            {id: 'rhtbtc', name: 'RHT/BTC', base_unit: 'rht', quote_unit: 'btc', price_precision: 5},
        ] as Market[];
